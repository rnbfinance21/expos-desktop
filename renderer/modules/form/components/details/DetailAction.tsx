...
import { checkKas, saveDraft, updateDraft } from "@/modules/order/api";
import { SaveDraftParams, UpdateDraftParams } from "@/modules/order/type";
...
const DetailAction = () => {
  ...
  const saveDraftMutation = useMutation(
    (params: SaveDraftParams) => saveDraft(token, params),
    {
      retry: false,
      onSuccess: (res) => {
        dispatch(resetOrder());
  ...
  const updateDraftMutation = useMutation(
    (params: UpdateDraftParams) => updateDraft(token, params),
    {
      retry: false,
      onSuccess: (res) => {
        dispatch(resetOrder());
