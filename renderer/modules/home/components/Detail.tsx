...
import { getOrderDetail } from "@/modules/order/api";
import { OrderDetail } from "@/modules/order/type";
import { numberFormat } from "@/utils/currency";
import { ucwords } from "@/utils/string";
import { DynamicHeroIcon, Loading } from "@/components/globals/icons";
import PaidAction from "@/modules/home/components/details/actions/PaidAction";
import PendingAction from "@/modules/home/components/details/actions/PendingAction";
import ProsesAction from "@/modules/home/components/details/actions/ProsesAction";
import DetailItem from "@/modules/home/components/details/DetailItem";
import InfoItem from "@/modules/home/components/details/InfoItem";
import DetailActionButton from "@/modules/form/components/details/DetailActionButton";
...
const Detail = () => {
  ...
  const { isRefetching, refetch, status } = useQuery(
    ["orderDetail", token],
    () => getOrderDetail(token, selectedOrder),
    {
      enabled: false,
      onSuccess: (res) => {
