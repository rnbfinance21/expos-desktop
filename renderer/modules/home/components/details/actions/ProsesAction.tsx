...
import { updateState, checkKas } from "@/modules/order/api";
import {
    OrderDetail,
    UpdateStateParams,
...
import PasscodeModal from "@/modules/shared/components/PasscodeModal";
import electron from "electron";
import { generateRandomString, ucwords } from "@/utils/string";
import GabungModal from "@/modules/home/components/details/GabungModal";
import UangKasModal from "@/modules/shared/components/UangKasModal";
import CetakModal from "@/modules/home/components/details/CetakModal";
...
const ProsesAction = ({ data }: ProsesActionProps) => {
    ...
    const changeStateMutation = useMutation(
        (params: UpdateStateParams) => updateState(token, params),
        {
            onSuccess: (res) => {
